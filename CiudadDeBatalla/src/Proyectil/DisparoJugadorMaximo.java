...
public class DisparoJugadorMaximo extends Proyectil {
	protected Visitante visitante=new VisitanteConcretoProyectilMaximo();

	public DisparoJugadorMaximo(int dir,float x,float y,int v,Tanque t) {
		super(dir,x,y,t);
		velocidad= v;
	}
